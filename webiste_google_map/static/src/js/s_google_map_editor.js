odoo.define('webiste_google_map.s_google_map_editor', function (require) {
    'use strict';
    ...
    var googleScriptLoaded = require("webiste_google_map.s_google_map_frontend").googleScriptLoaded;

    var _t = core._t;

    ajax.loadXML('/webiste_google_map/static/src/xml/s_google_map_modal.xml', core.qweb);
    ...
    s_options.registry.map = s_options.Class.extend({
        ...
        map: function (previewMode, value, $li) {
            ...
            this.dialog = new Dialog(this, {
                ...
                $content: $(core.qweb.render("webiste_google_map.s_google_map_modal"))
            });

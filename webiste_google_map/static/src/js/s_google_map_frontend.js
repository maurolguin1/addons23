odoo.define('webiste_google_map.s_google_map_frontend', function (require) {
    'use strict';
        ...
        start: function () {
            ...
            if (typeof google !== 'object' || typeof google.maps !== 'object') {
                if (!sAnimation.registry.s_google_map.isScriptLoading) {
                    ...
                    window.odoo_webiste_google_map_redraw_all = function odoo_webiste_google_map_redraw_all() {
                    ...
                    defs.push(this._rpc({
                        ...
                        $('head').append($('<script/>', {
                            ...
                            src: "https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&callback=odoo_webiste_google_map_redraw_all" + key_param,
                        }));
                    }));
                }
            } else {
        ...
        redraw: function () {
            ...
            if (this.$target.attr('data-pin-style') === "flat") {
                new google.maps.Marker({
                    ...
                    icon: "/webiste_google_map/static/src/img/marker.png",
